...
service('orderService', function($http) {
	this.getOrders = function(callback){
		$http.get('api/report/orders').success(function(data, status, headers, config) {
...
service('financialService', function($http) {
	this.getFinancials = function(callback){
		$http.get('api/report/financials').success(function(data, status, headers, config) {
			console.log("Received finances.");
			callback(data);
		})
	}
}).
